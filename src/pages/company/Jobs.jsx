...
export default function Jobs() {
		...
		await axios
			...
			.then((response) => {
				...
				localStorage.setItem(
					'id_company',
					response.data.data[0].id_company
				)
	...
	const peticionPut = async () => {
		await axios
			.put(CoUrlT + jobSelec.id + '/', jobSelec)
			.then((response) => {
				var dataNueva = data
				dataNueva.map((job) => {
							...
							<Grid item>
								...
								<FormControl sx={{ m: 1, minWidth: 250 }}>
									...
									>
										...
										<MenuItem value="temporal">
											Temporal
										</MenuItem>
										<MenuItem value="voluntariado">
											Voluntariado
										</MenuItem>
										<MenuItem value="prácticas">
											Prácticas
										</MenuItem>
									</Select>
								</FormControl>
						...
						>
							...
							<CardActions>
								<Box>
									<EditIcon
										onClick={() =>
											seleccionarJob(job, 'Editar')
										}
									/>
									&nbsp;&nbsp;&nbsp;
									<DeleteIcon
										onClick={() =>
											seleccionarJob(job, 'Eliminar')
										}
									/>
								</Box>
							</CardActions>
